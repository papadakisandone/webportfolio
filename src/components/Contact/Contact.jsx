...
const Contact = () => {
    ...
    const sendMessageHandler=(e)=>{
        e.preventDefault();
        emailjs.sendForm('service_lwc5cov','template_pt7vu1x', form.current, 'jt0RrpX-zGuPhwNnS')
        .then((result) => {
            ...
            <div className="container contact__container">
                <div className="contact__options">
                    <article className='contact__option'>
                        ...
                        <a href='mailto:papadakis.andone@gmail.com' target="_blank">Send a message</a>
                    </article>
                    <article className='contact__option'>
                        <FaFacebookMessenger className='contact__option_icon'/>
                        <h4>Messenger</h4>
                        <h5>Papadakis Antonios</h5>
                        <a href='https://m.me/antonis.papadakis' target="_blank">Send a message</a>
                    </article>
                    <article className='contact__option'>
                        <BsWhatsapp className='contact__option_icon'/>
                        <h4>WhatsApp</h4>
                        <h5>Papadakis Antonios</h5>
                        <a href='https:/api.whatsapp.com/send?phone=+12345678901' target="_blank">Send a message</a>
                    </article>
                </div>
                ...
                <form ref={form} onSubmit={sendMessageHandler}>
                    ...
                    {isSend && <div onClick={toggleInfo} className='form_msg-info'>
